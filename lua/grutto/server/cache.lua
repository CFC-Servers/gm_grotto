util.AddNetworkString( "grutto_request_cache" )
...
<!DOCTYPE html>
    ...
    <script type="text/javascript">
            if (typeof grutto_functions == "undefined") {
                console.log( "[GRUTTO] Can't find glua highlights." )
            }
            ace.require("ace/ext/language_tools");
            ace.config.setModuleUrl("ace/mode/glua", "ace-modes/mode-glua.js");
            ...
            if(typeof grutto !== "undefined") {
                editor.on("change", function() {
                    grutto.GetEditorContents(editor.getValue());
                });
                SetCode = function(contents){
    ...
    glualang = [===[define("ace/mode/glua_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
        "use strict";
        ...
        var gluaHighlightRules = function () {
            ...
            var functions = (typeof window.grutto_functions === "undefined") ? (
                ...
                "__mul|__div|__pow|__len|__eq|__le|__newindex|__tostring|__mode|__tonumber") : window.grutto_functions;
            var stdLibaries = (typeof window.grutto_libraries === "undefined") ? ("string|package|os|io|math|debug|table|coroutine") : window.grutto_libraries;
    ...
    define("ace/mode/folding/glua", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function (require, exports, module) {
        ...
        (function () {
            ...
            this.getFoldWidgetRange = function (session, foldStyle, row) {
                ...
                if (match) {
                    if (match[1])
                        return this.gluaBlock(session, row, match.index + 1);
                    if (match[2])
            ...
            this.gluaBlock = function (session, row, column, tokenRange) {
    ...
    define("ace/mode/glua", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/glua_highlight_rules", "ace/mode/folding/glua", "ace/range", "ace/worker/worker_client"], function (require, exports, module) {
        "use strict";
        var oop = require("../lib/oop");
        ...
        (function () {
            ...
            this.getMatching = function (session, row, column) {
                ...
                if (startToken && startToken.value in indentKeywords)
                    return this.foldingRules.gluaBlock(session, row, column, true);
            };
        ...
        window.require(["ace/mode/glua"], function (m) {
